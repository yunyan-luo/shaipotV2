...
pub fn compute_hash_no_vdf(data: &str, hc_util: &mut HCGraphUtil, vdftime1: u64, vdftime2: u64) -> Option<(String, String)> {
    ...
    if header_time <= HARDFORK_TIMESTAMP_QB {
        ...
        let queen_path = hc_util.find_hamiltonian_cycle_v3_hex(&queen_hash_reversed, queen_bee_grid_size, 125, vdftime2);
